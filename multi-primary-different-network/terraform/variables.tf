...
variable "cluster3_name" {
  description = "Name of the third Kind cluster (discovery cluster)"
  type        = string
  default     = "cluster3"
}
...
variable "cluster3_metallb_ip_range" {
  description = "MetalLB IP address pool range for Cluster 3 / discovery cluster (within shared network subnet)"
  type        = string
  default     = "10.90.0.1-10.90.0.254"
}
