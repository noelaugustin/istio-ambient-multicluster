...
provider "helm" {
  alias = "cluster3"
  kubernetes {
    host                   = kind_cluster.cluster3.endpoint
    client_certificate     = kind_cluster.cluster3.client_certificate
    client_key             = kind_cluster.cluster3.client_key
    cluster_ca_certificate = kind_cluster.cluster3.cluster_ca_certificate
  }
}
